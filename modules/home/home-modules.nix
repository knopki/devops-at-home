{
  ...
  profiles-sk-at-alien-mount-remote = ./profiles/sk-at-alien-mount-remote.nix;
  profiles-sk-at-alien-neovim = ./profiles/sk-at-alien-neovim.nix;
  profiles-sk-at-alien = ./profiles/sk-at-alien.nix;
  profiles-sk-at-alien-pim = ./profiles/sk-at-alien-pim.nix;
}
