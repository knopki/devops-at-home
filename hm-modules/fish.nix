    ...
    mkMerge [
      {
        ...
        knopki.direnv.enable = true;
        knopki.fish.interactiveShellInit."99-direnv" = ''
      ...
      #
      (
        mkIf config.knopki.fish.defaultFuncs {
          home.file = {
      ...
      (
        mkIf config.knopki.fish.ffe {
          ...
          knopki.fish.shellInit."00-ffe" = "activate_fenv # activate fenv command";
        }
      )

      # load .profile
      (
        mkIf config.knopki.fish.loadProfile {
          ...
          '';
          knopki.fish.ffe = true;
          knopki.fish.shellInit."10-load-profile" =
      ...
      # fix $TERM
      (
        mkIf config.knopki.fish.fixTerm {
          ...
          '';
          knopki.fish.interactiveShellInit."00-fix-term" =
      ...
      # colorize man pages
      (
        mkIf config.knopki.fish.colorizeMan {
          ...
          '';
          knopki.fish.interactiveShellInit."50-colorize-man" =
      ...
      # colorize man pages
      (
        mkIf config.knopki.fish.pureTheme {
